    ...
    const cardsData = [
      {
        ...
        testimonial: "PayNode transformed our HR operations completely. Managing 150+ employees has never been easier!",
      ...
      },
      {
        ...
        handle: "@mikehr",
        date: "January 8, 2025",
        testimonial: "The payroll automation feature saved us 20 hours per month. Our team loves the seamless experience.",
        company: "GrowthPartners Inc"
      },
      {
        image:
        ...
        testimonial: "Employee tracking and communication features are game-changers. Highly recommend PayNode!",
        company: "StartupHub"
      },
      {
        image:
        ...
        name: "David Thompson",
        handle: "@dthompson_ceo",
        date: "January 2, 2025",
        testimonial: "Finally, an employee management system that actually works. Our productivity increased by 30%.",
        company: "InnovateNow"
      },
    ];
      ...
      <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 bg-white">
        <div className="flex gap-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-blue-600 font-medium">{card.company}</span>
          </div>
        </div>
